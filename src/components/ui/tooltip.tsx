  ...
  return (
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Content
        ...
        className={cn(
          'z-50 w-fit rounded-lg border border-border/50 bg-card px-3 py-2 text-xs font-normal text-neutral-950 shadow-[0_8px_24px_rgba(15,23,42,0.12)]',
      ...
      >
        {children}
        <TooltipPrimitive.Arrow className="fill-card stroke-border/50 stroke-[0.5]" />
      </TooltipPrimitive.Content>
    </TooltipPrimitive.Portal>
  );
}
