...
export function DepartmentOverviewPage() {
  ...
  useEffect(() => {
    ...
    navigate(`/department-overview/${managedDepartments[0]!.reference}`, { replace: true });
        ...
        <PageShell className="pb-0">
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div>
              ...
              <h1 className="text-lg font-semibold text-foreground">Department overview</h1>
            ...
            <Select
              ...
              onValueChange={(value) => navigate(`/department-overview/${value}`)}
